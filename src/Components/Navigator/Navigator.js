            ...
            <nav className="fixed top-0 w-100 z-1">
                <ul className="list top-0 ml3 ml0-ns">
                    ...
                    <li className="dib-ns dn pv2 ml5-ns ml3 mr0-ns ml5-m">
                        <p onClick={this.btnAlbums} class="btn link dib pa2 pv2 black pointer grow mb0 z-2"><ImMenu3 style={{ fontSize: '15px' }} /><span> Albums </span></p>
                    </li>
                    <li className="dn-ns dib pv2 ml5-ns ml3 mr0-ns">
                        <p onClick={this.btnMenu} class="link dib pa2 pv2 black ba br2 pointer grow dim mb0"><ImMenu3 style={{ fontSize: '15px' }} /><span> Menu </span></p>
                    </li>
                    <li className="dib pv2 w-40-ns w-100-m w-100 tl ml4-ns ml5-m mr0-ns mr5 ">
                        <input class="gray white pa2 b--transparent br3 grow mr1 w-70 ml0" type="text" placeholder="Search.." name="search" />
                        <button class="searchBtn pa2 white b--transparent br3 dim grow pointer" type="submit"><BiSearchAlt2 style={{ fontSize: '15px' }} /></button>
                    </li>
                    <li className="dib-ns pv2 fr-ns fl-m ml5-m mr3-m mr3-ns dn">
                        <p onClick={() => onRouteChange('support')} href="0#" class="btn link db dib-l pa2 pv2 black pointer grow"><span>Support</span></p>
                    </li>
                    <li className="dib-ns pv2 fr-ns fl-m ml5-m mr2-ns dn">
                        <p onClick={() => onRouteChange('signin')} class="btn link dib pa2 pv2 black pointer grow"><span>Sign in</span></p>
                    </li>
